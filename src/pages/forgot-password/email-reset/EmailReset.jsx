        ...
        <div className='forgot__password'>
            <div className='fp__section'>
                ...
                <div className='fp__div2 emailreset__content'>
                    ...
                    <span className='p__head'><img src={vector} alt='email-reset'/></span>

                    {/* <div className='ppp'> */}
                        <h3>Check Your Mail</h3>
                        <p className='p1'>We’ve sent a password recovery instruction to your email address.</p>

                        <button>Open the Email app</button>
                        <p className='p2'>Didn’t receive any email? <a href='/#'>Resend link.</a> </p>
                    {/* </div> */}
                </div>
